...
<body>
    ...
    <section class="max-w-5xl mx-auto px-6 py-12 mb-8" id="travel-detail">
        <!-- Header Section -->
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900">HaramainKU Travel</h1>
            <p class="text-sm md:text-base text-gray-600 mt-2">Penyedia perjalanan umrah dan haji dengan layanan
                terbaik dan terpercaya.</p>
        </div>

        <!-- Travel Image & Info -->
        <div class="grid md:grid-cols-2 gap-8 items-center">
            <img src="{{ asset('images/travel1.png') }}" alt="HaramainKU Travel"
                class="w-full h-auto rounded-lg shadow-lg">

            <div>
                <h2 class="text-xl font-semibold text-gray-800">Tentang HaramainKU</h2>
                <p class="text-gray-600 mt-3">HaramainKU Travel telah berpengalaman lebih dari 10 tahun dalam
                    menyediakan layanan perjalanan haji dan umrah. Kami berkomitmen memberikan pengalaman ibadah yang
                    nyaman dan berkesan.</p>

                <div class="mt-4">
                    <h3 class="text-lg font-semibold text-gray-800">Layanan Kami:</h3>
                    <ul class="list-disc pl-5 text-gray-600 mt-2">
                        <li>Paket Umrah Reguler & VIP</li>
                        <li>Haji Plus & Furoda</li>
                        <li>Wisata Religi ke Timur Tengah</li>
                        <li>Layanan Visa & Tiket</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <!-- Gallery Section -->
        <div class="mt-12">
            <h3 class="text-2xl font-semibold text-gray-900 text-center">Galeri Perjalanan</h3>
            <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
                <img src="{{ asset('images/dummy.jpg') }}" class="w-full h-40 object-cover rounded-lg shadow-lg">
                <img src="{{ asset('images/dummy.jpg') }}" class="w-full h-40 object-cover rounded-lg shadow-lg">
                <img src="{{ asset('images/dummy.jpg') }}" class="w-full h-40 object-cover rounded-lg shadow-lg">
            </div>
        </div>
