...
<body>
    ...
    <section class="max-w-7xl mx-auto px-6 py-12 mb-8" id="travel">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-xl md:text-3xl font-bold text-gray-900">Mitra Travel Kami</h1>
                <p class="text-xs md:text-sm text-gray-600 mt-1">Kami bekerja sama dengan berbagai travel terpercaya
                    untuk perjalanan terbaik Anda.
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <!-- Travel 2 -->
            <a href="detail-travel/elmarwa.html"
                class="bg-white shadow-lg rounded-lg p-4 flex flex-col items-center hover:scale-105 transition-transform duration-300">
            ...
            <!-- Travel 3 -->
            <a href="detail-travel/uhudtour.html"
                class="bg-white shadow-lg rounded-lg p-4 flex flex-col items-center hover:scale-105 transition-transform duration-300">
            ...
            <!-- Travel 4 -->
            <a href="detail-travel/arsytour.html"
                class="bg-white shadow-lg rounded-lg p-4 flex flex-col items-center hover:scale-105 transition-transform duration-300">
            ...
            <!-- Travel 5 -->
            <a href="detail-travel/namiratravel.html"
                class="bg-white shadow-lg rounded-lg p-4 flex flex-col items-center hover:scale-105 transition-transform duration-300">
                <img src="{{ asset('images/travel5.png') }}" alt="Travel 5" class="w-20 h-20 object-cover mb-3">
