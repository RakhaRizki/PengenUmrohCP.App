...
<body>
    ...
    <section class="max-w-7xl mx-auto px-6 py-12 mb-6" id="galeri">
        <!-- Header & Filter Section -->
        <div class="flex flex-wrap justify-between items-center mb-6">
            <div>
                <h1 class="text-xl md:text-3xl font-bold text-gray-900">Galeri</h1>
                <p class="text-xs md:text-sm text-gray-600 mt-1">
                    Lihat pengalaman pelanggan kami yang puas dengan layanan terbaik.
                </p>
            </div>
            <!-- Filter Kategori -->
            <div class="flex flex-wrap gap-4 mt-6 sm:mt-6">
                <button
                    class="category-btn active bg-orange-500 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-md hover:bg-orange-600 transition"
                    data-category="all">
                    Semua
                </button>
                <button
                    class="category-btn bg-gray-200 px-4 py-2 rounded-full text-sm font-semibold shadow-md hover:bg-orange-600 transition"
                    data-category="umrah">
                    Umrah
                </button>
                <button
        ...
        <!-- Gallery Section -->
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 opacity-100 transition-opacity duration-500"
            id="gallery">
            <!-- Default Images -->
            <div class="gallery-item all umrah relative overflow-hidden rounded-lg shadow-lg">
                <a href="detail-galeri.html">
                    <img src="{{ asset('images/dummy.jpg') }}" alt="Umrah 1"
                        class="w-full h-full object-cover hover:scale-110 transition-transform duration-300">
                </a>
            </div>
            <div class="gallery-item all haji relative overflow-hidden rounded-lg shadow-lg">
                <a href="detail-galeri.html">
                    <img src="{{ asset('images/dummy.jpg') }}" alt="Haji 1"
                        class="w-full h-full object-cover hover:scale-110 transition-transform duration-300">
                </a>
            </div>
            <div class="gallery-item all wisata relative overflow-hidden rounded-lg shadow-lg">
                <a href="detail-galeri.html">
                    <img src="{{ asset('images/dummy.jpg') }}" alt="Wisata 1"
                        class="w-full h-full object-cover hover:scale-110 transition-transform duration-300">
                </a>
            </div>
            <div class="gallery-item all umrah relative overflow-hidden rounded-lg shadow-lg">
                <a href="detail-galeri.html">
                    <img src="{{ asset('images/dummy.jpg') }}" alt="Umrah 2"
                        class="w-full h-full object-cover hover:scale-110 transition-transform duration-300">
                </a>
            </div>
        </div>
        ...
        <div class="flex justify-center mt-16">
            <a href="{{ route('/') }}"
                class="flex items-center px-6 py-3 text-lg font-semibold text-white bg-orange-500 rounded-full shadow-md hover:bg-orange-600 transition duration-300 ease-in-out transform hover:scale-105">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        buttons.forEach(button => {
            button.addEventListener("click", function() {
                ...
                setTimeout(() => {
                    items.forEach(item => {
                        if (category === "all" || item.classList.contains(
                                category)) {
